...
const Team = () => {
  ...
  return (
    <div>
      {/* [#2e9afe] */}
      <div className="top my-auto text-center h-10 p-1 bg-yellow-500 text-white text-lg font-medium">
...
{/* #2e9afe */}
      <div className="p-4 rounded-xl bars w-4/5 mx-auto mt-10 bg-yellow-500 text-white">
      ...
      <div className="p-4 rounded-xl bars w-4/5 mx-auto mt-3 bg-yellow-500 text-white">
