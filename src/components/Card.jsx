  ...
  return (
    <div className='mx-1 mb-1'>
        ...
        <div className="info  bg-yellow-500 p-2 text-sm">
            ...
            <div className="cursor-pointer btn text-white text-center p-2 mt-1 text-lg rounded-md  w-4/5 mx-auto bg-green-600" onClick={()=>handleClick(product_type ,plan_name, plan_type, plan_amount, plan_daily_earning, plan_cycle)}>Click to buy</div>
        </div>
    </div>
  )
}
