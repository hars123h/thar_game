...
const Card = ({prodcut_type, product_image, plan_name, plan_type, plan_amount, plan_daily_earning, plan_cycle, handleClick}) => {
  return (
    <div className='mx-1 mb-1'>
        <img src={product_image} alt="comp_img" className='border-2 border-gray-200 shadow-lg' />
        <div className="info  bg-[#0096D5] p-2 text-sm">
            ...
            <div  className="cursor-pointer btn text-white text-center p-2 mt-1 text-lg rounded-md  w-4/5 mx-auto bg-[#00bcd4]" onClick={()=>handleClick(prodcut_type ,plan_name, plan_type, plan_amount, plan_daily_earning, plan_cycle)}>Click to buy</div>
        </div>
    </div>
  )
}
