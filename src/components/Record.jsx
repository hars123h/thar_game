...
//[#2e9afe]
    return (
        <div className=' bg-yellow-500 pb-3 sm:h-[1000px] md:h-screen h-screen'>

            <div className="options text-center text-white flex gap-2 items-center p-2  bg-yellow-500 text-lg pt-2 font-medium">
...
{/* [#bfdbf5] */}
            <div className='flex flex-wrap items-center py-2 px-4 bg-yellow-400 border-b border-white'>
...
{/* [#2e9afe] */}
                <button className='bg-yellow-500 shadow-lg w-20 text-center  ml-3 text-white rounded-full p-2.5'>Search</button>
            </div>
{/* [#bce4ed] */}
            <div className='records w-full flex bg-yellow-400 items-center'>
            ...
            <div className=' overflow-y-scroll h-[500px] m-5'>
                {(currentRecord === 'recharges' || currentRecord === 'all') && recharge_list && recharge_list.map((element, id) => {
                    // blue-400
                    return (
                        <div key={id} className="bg-yellow-600 rounded-lg shadow-md p-2 text-white mt-2 mx-2">
