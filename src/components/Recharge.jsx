...
//[#2e9afe] #4daaff #298ae4 [#2e9afe]
  return (
    <div className='bg-yellow-400 h-screen'>
        ...
        <div className="box bg-yellow-600 px-4 py-4 shadow-md shadow-yellow-200">
        ...
        <div className="cnf_recharge w-4/5 mx-auto mt-10">
            <button onClick={handleRecharge}  className='w-full bg-yellow-600 py-2 rounded-md text-white text-lg shadow-customShadow shadow-[#beadcc]'>Confirm Recharge</button>
        </div>
    </div>
  )
}
